...
<html lang="en">
  ...
  <body class="violetgradient">
            ...
            <div class="greyarea">
                ...
                <form id="form1" autocomplete="off">
                    <div class="formitem">
                        ...
                        <input type="text" class="forminput" id="prodidorder" placeholder="Product ID ORDER....."  required>
                        <input type="text" class="forminput" id="prodname" placeholder="Name product ....."  required>
                        <input type="text" class="forminput" id="prodmanu" placeholder="Origin .......... " required>
                        <input type="text" class="forminput" id="proddelive" placeholder="Deliver By .......... " required>
    ...
    $('#form1').on('submit', function(event) {
        ...
        prodidorder = $('#prodidorder').val();
        prodmanu  = $('#prodmanu').val();
        proddelive = $('#proddelive').val();
        username = $('#user').val(); 
        prodname=prodname+"<br>ID order: "+prodidorder+"<br>Registered By: "+username+ "<br>Origin :"+ prodmanu+ "<br>Deliver By :"+ proddelive;
