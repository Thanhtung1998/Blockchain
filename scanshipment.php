...
<html lang="en">
  ...
  <?php
    if( $_SESSION['role']==0 || $_SESSION['role']==1  ){   // cho phep role co gia tri 0 va 1 truy cap
  ?>
  <body class="violetgradient">
        ...
        <div class="mycardstyle">
            <div class="greyarea">
                ...
                <form id="form2" autocomplete="off">
                    ...
                    <div class="formitem">
                        <label type="text" class="formlabel"> Information Shipment </label>
                        <input type="text" class="forminput" id="prodlocation" placeholder="Location" required>
                        <input type="text" class="forminput" id="prodTemperature" placeholder="Temperature" required>
                        <input type="text" class="forminput" id="prodHumidity" placeholder="Humidity" required>
                        <input type="text" class="forminput" id="prodstatus" placeholder="Status" required>
    ...
    $('#form2').on('submit', function(event) {
        ...
        var today = new Date();
        var thisdate = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+today.getDate()+ ' ' +'Time: '+today.getHours()+':'+today.getMinutes()+':'+today.getSeconds();
        var info = "<br><br><b>Date: "+thisdate+ "</b><br>Deliver By: "+username+"<br>Location: "+prodlocation + "<br>Temperature Ship: " + prodTemperature + "<br>Humidity Ship: " + prodHumidity +"<br>Status :"+ prodstatus;
        web3.eth.getAccounts().then(async function(accounts) {
